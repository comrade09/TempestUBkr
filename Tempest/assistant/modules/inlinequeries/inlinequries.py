    ...
    if query.startswith("#pmpermit"):
        ...
        results=[
            InlineQueryResultPhoto(
                ...
                title="TempestUB Inline security system",
                description="Get Tempest security system inline menu.",
        ...
        results=[
            InlineQueryResultPhoto(
                ...
                title="TempestUB Inline helpdex menu",
        ...
        results=[
            InlineQueryResultArticle(
                title="TempestUB Inline anime quotes",
