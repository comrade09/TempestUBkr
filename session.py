...
with Client("Tempestbot", api_id=API_ID, api_hash=API_HASH) as app:
  app.send_message("me", f"This Is Your Tempest Userbot • [ `SESSION` ]\n\n```{app.export_session_string()}```\n\n⚠️• Don't share this with anyone !!\n\nCreate session online • [ Press Here](https://t.me/TempestSessionBot)", disable_web_page_preview=True) 
